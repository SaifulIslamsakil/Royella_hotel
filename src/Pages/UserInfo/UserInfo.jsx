...
const UserInfo = () => {
    ...
    const { RoomTitle, name, bard, price,img, RoomSizee } = find

    const handelRoomBooking = event =>{
        ...
        axios.post("https://royella-hotel-server.vercel.app/api/v1/RoomBooking",info)
        .then(res=>{
            Swal.fire({
                title: "Good job!",
                text: "your apply sueccessfully added!",
                icon: "success"
              });
        })
    }
                    ...
                    <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                            ...
                            <div className="lg:col-span-2">
                                ...
                                <form onSubmit={handelRoomBooking}>
